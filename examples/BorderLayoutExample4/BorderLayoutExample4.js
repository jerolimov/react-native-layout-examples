...
import React, { Component, View, Text, Modal } from 'react-native';
...
import Overlay from 'react-native-layout/lib/Overlay';

export default class BorderLayoutExample4 extends Component {
	constructor() {
		super();
		this.state = {
			overlay: false
	...
	render() {
		...
		return (
			<Fill>
				...
				<Modal animated={ true } visible={ overlay }>
					<Center>
